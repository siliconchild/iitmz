...
import { academicOrdinancesData } from "@/data/ordinances";
    ...
    <div className={styles.page}>
      <div className="container">
        <div className={styles.header}>
          <h1>Ordinances</h1>
          <p>
            The Ordinances and Regulations govern academic matters and provide
            in detail, the rules for specific areas such as Admissions,
            Assessment procedures, Grading, etc. The Academic rules governing
            the various programmes at the Institute are linked below.
          </p>
        </div>
        <div className={styles.ordinanceGrid}>
          {academicOrdinancesData.map((ordinance) => (
            <div className={styles.ordinance} key={ordinance.link}>
              <Link href={ordinance.link} target="_blank">
                <svg
