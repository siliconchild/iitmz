...
import { academicCalendarData } from "@/data/calendar";
      ...
      <div className={styles.page}>
        <div className="container">
          <div className={styles.header}>
            ...
            <p>
              The dates below represent official academic deadlines and
              informational dates for the semester displayed.
            </p>
          </div>
          <div className={styles.calendarGrid}>
            {academicCalendarData.map((calendar) => (
              <div className={styles.calendar} key={calendar.link}>
                <Link href={calendar.link} target="_blank">
                  <svg
