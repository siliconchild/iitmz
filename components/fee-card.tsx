...
export function CourseFeeCards({ children }: CourseFeeCardsProps) {
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.feeCardsContainer}>{children}</div>
      <div className={styles.feeDetails}>
        ...
        <ol className={styles.list}>
          <li>
            ...
            Students may choose on-campus or off-campus accommodation. Off-campus students needn’t pay the
            hostel accommodation &amp; mess fee.
          </li>
          <li>
            <BsArrowRightCircleFill />
            Students living on or off-campus may avail the dining facility on the campus by paying the dining
            facility fee. Partial availing of the dining will not be permitted.
          </li>
        </ol>
