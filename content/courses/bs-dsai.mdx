...
<li>
  ...
  Students who completed the qualifying exam from the year 2022 are eligible
  </li>
  </p>
  <p>
  <li>
  <BsArrowRightCircleFill />
  Students currently in Grade 12/Form VI or equivalent (Passing out in May/July ‘25)
  </li>
  </p>
  </ol>
</CourseEligibility>
...
The BS test will be of 3 hours duration, and it will be conducted only on **Sunday.**

For 2025, the screening test for BS will be conducted in the following days

Option 1: May 04, 2025 (Sunday) | Time: 02:00 - 05:00 PM IST

Option 2: July 13, 2025 (Sunday) | Time: 02:00 - 05:00 PM IST
...
<CourseResources>
  ...
  />
  <Resource
    title="2023 BS Screening Test Question Paper"
    link="/BS2023ScreeningTestQuestionPaper.pdf"
  />
  <Resource
    title="2024 BS Screening Test Question Paper"
    link=""
  />
  <Resource
    title="BS Sample Questions"
    link="/IITMZST_BS_Sample_Questions.pdf"
  />
  <Resource
    title="Download BS in DSAI Flyer"
    link="/BS-MTech-Flyer.pdf"
  />
</CourseResources>

<section>
To start your BS in Data Science &amp; AI Application

BS in Data Science &amp; AI Application Portal : [Click Here](https://admissions.iitmz.ac.in/bsdsai)
...
<CourseResources>
  <Resource
    title="International Test Centers: 20 Cities"
    link="/MTech_OS_Screening_Test Syllabus.pdf"
  />
  <Resource
    title="Indian Test Centers: 54 Cities"
    link="/IITMZ-BS-Screening-Test-Syllabus.pdf"
  />
</CourseResources>
