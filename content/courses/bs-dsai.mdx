...
<section>
<h3>Description</h3>
<p>Welcome to the Bachelor of Science in Data Science and Artificial Intelligence (BS DSAI) program at IITM Zanzibar Campus. Our program is designed to equip students with the knowledge and skills needed to thrive in the fast-paced and ever-evolving field of data science and artificial intelligence. As a student in our program, you will embark on a comprehensive learning journey that blends foundational science and mathematics courses with specialised DSAI subjects. With a strong emphasis on practical experience and project-based learning, you will have the opportunity to apply your knowledge to real-world challenges and gain hands-on expertise in data analysis, machine learning, natural language processing and more.</p>
</section>

<JobProspects>
<p>
With the exponential growth of data and the increasing demand for data-driven insights, the job prospects for graduates in data science and artificial intelligence are numerous and diverse. As a graduate of our program, you will be well-prepared to pursue exciting career opportunities in various industries. Furthermore, our program aims to foster an entrepreneurial mindset, equipping you with the skills to launch your own data-driven startups or pursue advanced studies in data science and AI.
</p>
<ul>
<li>Data analyst or data scientist in tech companies, consulting firms, and research organisations.</li>
<li>Machine learning engineer or AI specialist in industries such as finance, healthcare, and e-commerce.</li>
<li>Business analyst or data strategist in companies leveraging data for strategic decision- making.</li>
</ul>
</JobProspects>
...
<Semester title="Semester I" credits="47">
  ...
  >
    <CourseContent>
      ...
      **Thermodynamics:** First law - energy, work, and heat; Second law - entropy; Applications of laws for ideal gas; Phase transitions - van der Waals equation of state

      **Quantum mechanics:** The quantum nature of radiation, interference experiment with radiation and particle beams, Schrodinger wave equation, Applications to simple physical systems (free particle, particle in a box, and barrier penetration)

      **Statistical mechanics:** Phase space, distribution functions, ergodic hypothesis, statistical ensembles, Maxwell-Boltzmann distribution, equipartition theorem, kinetic theory, thermal fluctuations, Brownian motion
    </CourseContent>
  ...
  >
    <CourseContent>
      Typology of data, Physical process variables, Units and dimensions, Homogeneity & unit conversions, Estimation of numerical values, Significant figures, Errors and error propagation

      Working with spreadsheets: basic manipulations & calculations, Conceptual thinking with data science examples
    </CourseContent>
  ...
  >
    <CourseContent>
      ...
      **Python Fundamentals:** Variables, expressions, and statements; Conditional execution; Functions; Iterations; Recursion; Basic Python data types (lists, strings, dictionaries, tuples)

      File handling; Extending Python; Error handling; Regular expressions and Parsing; Testing, Debugging, Exceptions, Assertions

      Object-oriented programming in Python; Understanding program performance; Profiling code
  ...
  >
    <CourseContent>
      Reading of autobiographical literature from various regions; Analyzing common elements and differences in language and structure

      Writing exercises on intellectual development, childhood, and current experiences

      Breaking down writing pieces to understand coherence, cogency, and grammar

      Depicting ideas and information visually through graphs, charts, and presentations

      Writing longer pieces, including essays and articles; Applying principles of good writing
    </CourseContent>
...
<Semester title="Semester III" credits="51">
  ...
  >
    <CourseContent>
      ...
      <strong>Programming and Data Structures including Lab</strong>
      Introduction to algorithms and data structures
    </CourseContent>
