...
<Section id="eligibility">
  ...
  <List>
    <ListItem>
      ...
      Class 12 Examination recognized by the Central/ Indian State Board (CBSE, Matriculation etc.). Physics, Chemistry and Mathematics as compulsory subjects in high school level.
    </ListItem>
    <ListItem>
      <BsFillCheckCircleFill />
