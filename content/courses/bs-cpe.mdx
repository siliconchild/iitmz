...
language: English
flyerLink: /BS-CPE-Program-Flyer.pdf
applicationLink: https://admissions.iitmz.ac.in/bscpe
applicationClosingDate: 05 July 2025
...
<p>
  ...
  <h5>For 2025, the screening test for BS will be conducted on</h5>
  <List>
    <ListItem>
...
<Section id="screening-test-resources">
  ...
  <Documents>
    ...
    <Document href="/IITMZST-Information-Brochure-2025_BS-CPE.pdf">
      <div className="icon">
        <FaFilePdf />
      </div>
      <div className="info">
