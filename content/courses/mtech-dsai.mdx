...
title: MTech in Data Science & AI/ PG Diploma in Data Science
type: oncampus
...
cardImg: /course4.jpg
coverImg: /cd3x.png
duration: 2 Years (for 4 year UG Degree holders)
credits: 190 (for MTech degree alone)
department: Engineering & Science
language: English
flyerLink: /mtech-program-flyer.jpeg
applicationLink: https://admissions.iitmz.ac.in/mtechdsai
applicationClosingDate: 24 November 2025
seo:
...
<Section>
  ...
  <p>
      Our program is designed to provide students with advanced knowledge and specialised skills in the fields of data science and artificial intelligence, preparing them for leadership roles in industry and research. In this special application drive, we are also welcoming students with three year UG degrees into an integrated program including a 96 credit diploma "Post Graduate Diploma in Data Science" from IITM Zanzibar (Jan - Oct 2026), followed by the two year MTech degree in Data Science & AI from IITM, offered at the Zanzibar campus.
  </p>
  <p>
...
<Section id="eligibility">
  ...
  <List>
    <ListItem>
      ...
      Bachelor's degree with specialization in Engineering/Technology and Science
    </ListItem>
    <ListItem>
      <BsFillCheckCircleFill />
    ...
    <ListItem>
      <BsFillCheckCircleFill />
      For the MTech DS &amp; AI program, there is no age limit. Anyone who meets the minimum
...
<Section id="fee-structure">
  ...
  <List>
      <ListItem>
          <FaCoins />
          For the PG Diploma in Data Science, the tuition fee is $2000 (for the entire programs)
      </ListItem>
      <ListItem>
          <FaCoins />
          For the MTech Degree in Data Science & AI, the tuition fee is $12000 (for the entire two year program)
      </ListItem>
    </List>
  <h4>Hostel Fee</h4>
  <br />
...
<Section id="screening-test">
  <h3>Screening Test</h3>
   <p>
       Applicants will have to appear in the online screening test. The screening test will be in English and consists of objective type multiple choice questions (MCQs), multiple select questions (MSQs) and numerical answer type questions (NAT). Detailed instructions will be provided in the question paper provided during the exam. Candidates must follow the guidelines for the screening test sent via email.The test will be of 2 hours duration, and it is tentatively scheduled for Sunday 30 Nov 2025. Candidates whose applications are complete will receive information about resource materials to help them prepare for the test.
  </p>
...
<Section>
  ...
  <Documents>
  <Document href="/IITMZST-Information-Brochure-MTech-dsai-2025.pdf">
    <div className="icon">
      <FaFilePdf />
    </div>
    <div className="info">
    ...
    <Document href="/MTech2023ScreeningTestQuestionPaper.pdf">
      ...
      <div className="info">
        <h4>MTech Question Paper 2023</h4>
     ...
     <Document href="/IITMZST_MTech_Sample_Questions.pdf">
      ...
      <div className="info">
        <h4>MTech Sample Question Paper</h4>
...
<ApplyCard
  ...
  description="Take the first step towards your future at IIT Madras Zanzibar. Applications will open again in Jan 2026, Stay tuned."
