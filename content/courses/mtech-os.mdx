...
<p>
 The MTech OS test will be of 2 hours duration, and it will be conducted only on{" "}
  ...
  <h4>For 2025, the screening test for MTech OS will be conducted in the following days</h4>
  <List>
    <ListItem>
      <BsArrowRightCircleFill />
...
<Section>
  ...
  <Documents>
    ...
    <Document href="#">
      ...
      <div className="info">
        <h4>2024 MTech OS Question Paper</h4>
     ...
     <Document href="/IITMZ-M.Tech-In-Ocean Structures-1.pdf">
      ...
      <div className="info">
        <h4>Download MTech in OS Flyer</h4>
