...
<Section id="eligibility">
  ...
  <List>
    ...
    <ListItem>
      <BsFillCheckCircleFill />
      For the M.Tech. OS program, there is no age limit. Anyone who meets the minimum
...
<p>The M.Tech. Ocean Structures program offers a global academic experience with Semesters
...
<Section id="screening-test">
  <h3>M.Tech. OS Screening Test</h3>
   <p>
Candidates applying to M.Tech. Ocean Structures program will have to appear in the online
...
<p>
 The M.Tech. OS test will be of 2 hours duration, and it will be conducted only on{" "}
...
<ApplyCard
  ...
  buttonLink="https://admissions.iitmz.ac.in/mtechos"
